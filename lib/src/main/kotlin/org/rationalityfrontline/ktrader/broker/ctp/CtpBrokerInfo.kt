...
object CtpBrokerInfo {
    ...
    val configKeys: List<Pair<String, String>> = listOf(
        ...
        Pair("flowSubscribeType", "String 交易API的私有流及公有流的订阅模式，共3种：RESTART、RESUME、QUICK，默认为 QUICK"),
    ...
    val methodExtras: List<Pair<String, String>> = listOf(
        ...
        Pair("queryInstrument", "[queryFee: Boolean = false]【是否查询保证金率及手续费率，如果之前没查过，可能会耗时】"),
    )
