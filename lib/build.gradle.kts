...
dependencies {
    ...
    compileOnly("org.rationalityfrontline.ktrader:ktrader-utils:0.1.5")
    val jctp = if (asTest) "org.rationalityfrontline:jctp:6.7.2_CP-1.0.5" else "org.rationalityfrontline:jctp:6.7.2-1.0.5"
